...
// PollSet.cpp
//
// $Id: //poco/1.7/WebTunnel/include/Poco/WebTunnel/Protocol.h#1 $
//
// Library: WebTunnel
// Package: WebTunnel
// Module:  PollSet
...
#include "Poco/WebTunnel/PollSet.h"
...
//
// HACK - will go away if we integrate this in POCO Net
//
class SocketImpl: public Poco::Net::SocketImpl
{
public:
	static int lastError()
	{
		return Poco::Net::SocketImpl::lastError();
	}
