...
rem for MS Visual Studio 2008 to 2015
rem
rem $Id: //poco/1.7/dist/buildwin.cmd#1 $
rem
rem Copyright (c) 2006-2015 by Applied Informatics Software Engineering GmbH
...
rem VS version {90|100|110|120|140}
if "%1"=="" goto usage
set VS_VERSION=vs%1
